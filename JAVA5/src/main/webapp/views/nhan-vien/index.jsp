...
<a href="/nhan-vien/create" class="btn btn-success mt-3">Add</a>
        ...
        <c:forEach var="nhanVien" items="${ list }" varStatus="status">
            <tr>
                ...
                <td class="text-center">
                    <a href="/nhan-vien/update?ma=${ nhanVien.ma }"
                       class="btn btn-primary">Update</a>
                    <a href="/nhan-vien/delete?ma=${ nhanVien.ma }"
