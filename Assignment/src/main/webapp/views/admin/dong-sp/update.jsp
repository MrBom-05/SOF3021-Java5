...
<h2 class="mt-3 text-center">Cập Nhật Dòng Sản Phẩm</h2>
...
<form class="col-6 offset-3 mt-5 border p-4" novalidate method="POST"
    ...
    <div class="col-12">
        ...
        <input type="text" class="form-control" name="ma" required disabled value="${dongSP.ma}" onblur="validateRed(this)">
    </div>

    <div class="col-12 mt-3">
        <label class="form-label">Tên<span class="text-danger">*</span></label>
        <input type="text" class="form-control" name="ten" required value="${dongSP.ten}" onblur="validateRed(this)">
    </div>
