...
public interface PhieuGiamGiaRepository extends JpaRepository<PhieuGiamGia, String> {
    ...
    @Query("SELECT p FROM PhieuGiamGia p WHERE p.nguoiSoHuu.maKhachHang=:maKhachHang")
    public Page<PhieuGiamGia> getList2(@Param("maKhachHang") Long maKhachHang, Pageable pageable);
}
